...
-   Generalization of how quantile regression can be generalized to 
...
-   The OLS model is specified by minimizing the sum of squared residuals: $$
    ...
    $$
-   The sum of squared residuals is minimized by the mean of of $\hat{Y}$ given the predictors $X$
